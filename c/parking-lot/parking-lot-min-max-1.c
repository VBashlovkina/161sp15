/* program to determine parking fee for a downtown lot.
   ...
   Version 1-min-max:  
        ...
        code uses fmax and fmin from math.h to find maximum and minimum
...
int main ()
{
  ...
  if (start_time < 420)
    { double first_minute_rate = 1.25 / 60.0;
      fee1 = (fmin (end_time, 420) - start_time) * first_minute_rate;
    }
  ...
  if (start_time < 1020 && end_time > 420)
    { double second_minute_rate = 0.75 / 60.0;
      fee2 = (fmin(1020, end_time) - fmax(420, start_time))*second_minute_rate;
    }
  ...
  if (start_time < 1440 && end_time > 1020)
    { double third_minute_rate = 2.00 / 60.0;
      fee3 = (fmin(1440, end_time) - fmax(1020, start_time))*third_minute_rate;
    }
  ...
  if (start_time < 1860 && end_time > 1440)
    { double fourth_minute_rate = 1.25 / 60.0;
      fee4 = (fmin(1860, end_time) - fmax(1440, start_time))*fourth_minute_rate;
    }
  ...
  if (start_time < 2460 && end_time > 1860)
    { double fifth_minute_rate = 0.75 / 60.0;
      fee5 = (fmin(2460, end_time) - fmax(1860, start_time))*fifth_minute_rate;
    }
  ...
  if (end_time > 2460)
    { double sixth_minute_rate = 2.00 / 60.0;
      fee6 = (end_time - fmax(2460, start_time))*sixth_minute_rate;
    }
